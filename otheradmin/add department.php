...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO officers (username, email, password, role) VALUES (?, ?, ?, ?)");
...
<body>
    ...
    <h3>Add Department Or Officers Account</h3>

        <label for="username">Username:</label>
        <input type="text" id="username" name="username" required><br>
        <label for="email">Email:</label>
        <input type="email" id="username" name="email"  placeholder = "optional "><br>
        ...
        <center style="display:flex; justify-content:space-around; "></center>       
            <button type="submit" onclick="return confirm('realy add departmnent?');">Add </button>
