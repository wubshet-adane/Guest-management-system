...
<body>
    <div>     
        ...
        <?php 
            if ($reportCount > 0){
                echo "<center><h3>There are <b>" .$reportCount."</b> reports received from reception or officers!</h3></center>";
            }
            else{
    ...
    <div class="search">
        <a href="admin_index.php">Go home</a>
        ...
        <table>
            ...
            <?php foreach ($reports as $ripo): ?>
                <tr>
                    ...
                    <td>
                        <a href="delete_report.php?id=<?php echo urlencode($ripo['id']); ?>" class="dlete">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            <?php else: ?>
